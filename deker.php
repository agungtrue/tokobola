  ...
  <head>
    ...
    <body>
      <div id="container">
        ...
        <div id="content">
          <div class="title">
          <h5><b>Toko Kami menyediakan berbagai macam Deker dengan berbagai merek dan harga yang terjangkau :)</b></h5>
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-3">
                  <h4>Nike Epl</h4>
                  <img src="image/deker/deker4.jpg" alt="Nike EPL"  style="width:180px; height:150px;">
                  <p class="price"> Harga : Rp.149.999 </p>
                  <button type="button" class="btn btn-sm btn-success" data toggle="modal" data-target="#"> <a class="link" href="nike-epl-1.php"> Selengkapnya</a> </button>
                  <br><br>
              </div>
              ...
              <div class="col-md-3">
                  <h4>Nike Epl</h4>
                  <img src="image/deker/deker7.jpg" alt="Nike EPL" style="width:180px; height:170px;">
                  <p class="price"> Harga : Rp.149.999 </p>
                  <button type="button" class="btn btn-sm btn-success" data toggle="modal" data-target="#"> <a class="link" href="nike-epl-1.php"> Selengkapnya</a> </button>
              </div>
